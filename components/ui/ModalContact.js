    ...
    <BorderLayout>
      ...
      {/* <!-- Modal body --> */}
        <div className="pt-1 space-y-3">
          ...
          <button type="button" class="text-white bg-[#175bb0] hover:bg-[#043a7d] focus:ring-2 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-2xl  text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2"
          onClick={() => {
            window.open(
              ...
              "_blank"
                ...
                <svg
                  class="mr-2 -ml-1 w-7 h-7 text-blue-300 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512">
            ...
            <button type="button" class="text-white bg-[#565759] hover:bg-[#2f2f30] focus:ring-2 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-2xl  text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2"
            onClick={() => {
              window.open(
              ...
              <div className="font-bold mt-3">Paras Gaur [Blockchain Developer]</div>
